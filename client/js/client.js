...
// electron
var socket = require('socket.io-client')('http://10.0.0.115');
logic();
...
function logic () {
  ...
  socket.on('data', function(data) {
   ...
   document.getElementById('title-bar').style.background = "#"+data.ColorVals.CurrentHEX;
 ...
 socket.on('updatecolor', function(c) {
   ...
   document.getElementById('title-bar').style.background = "#"+c.CurrentHEX;
